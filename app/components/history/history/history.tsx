...
const History = () => {
  ...
  return (
    <>
      <div className={`h-full p-2 pt-0 bg-white w-full border border border-grey-100 shadow-sm rounded ${!isHistorySectionExpanded && '!h-[35px] transition-all duration-500 ease'}`}>
